...
#-----------------------------------------------------------
FASTQ_FILE="/work/qd33/nanopore/QD_ptrap_20230908/results_0/demux/barcode02_seqkit_subsample/barcode02_s7928_p.75.fastq.gz"
SAMPLE="barcode02_s7928_p.75" # Look into "workdir" snakemake config <https://stackoverflow.com/a/40997767>
NUM_THREADS=80
MEM_MB=600000
